		...
		function handleLink(e) {
		  ...
		  if (document.getElementById('newwin') && document.getElementById('newwin').checked) {
			window.open(el.href);
			if (window.event) {
		...
		function cancelClick() {
		  if (document.getElementById('newwin') && document.getElementById('newwin').checked) return false;
		  return true;
		}
