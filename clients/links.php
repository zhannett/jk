				...
				<div id="links">
					<div class="container">
						<dl class="accordion" data-behavior="accordion smartLinks">
							...
							<dt>
								<a href="#"><span></span> Installations on Mac</a>
							</dt>
							<dd>
								<ul>
									<li><a href="http://addyosmani.com/blog/client-side-build-process/">Client-Side Build Process</a></li>
									<li><a href="http:www.jonsblog.org/2011/11/28/installing-mysql-on-osx-lion-server" />Installing MySQL on OSX Lion Server</a></li>
						...
						<dl class="accordion" data-behavior="accordion">
							...
							<dd>
								<ul>
									...
									<li><a href="simplebits.com/">Examples of decorative fonts</a></li>
							...
							<dd>
								<ul>
									...
									<li><a href="/photographytips/2008/aperture_fstops_camera_settings.htm">www.picturecorrect.com</a></li>
