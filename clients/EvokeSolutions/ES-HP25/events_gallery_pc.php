						...
						<div id="rightCol">
							<div id="rightColWrapper">
									...
									<div id="videoplayerblock">
											<div id="videoplayer"><img src="img/president_cup_main_event.jpg" width="300" height="248" alt="" /></div>
									...
									<ul class="gallery">
											<li><a href="img/president_cup_event_1.jpg" class="thickbox" title="title 1" rel="gallery"><img src="img/president_cup_thumb_event_1.jpg" width="88" height="88" alt="" /></a></li>
											<li><a href="img/president_cup_event_2.jpg" class="thickbox" title="title 2" rel="gallery"><img src="img/president_cup_thumb_event_2.jpg" width="88" height="88" alt="" /></a></li>
											<li><a href="img/president_cup_event_3.jpg" class="thickbox" title="title 3" rel="gallery"><img src="img/president_cup_thumb_event_3.jpg" width="88" height="88" alt="" /></a></li>
											<li><a href="img/president_cup_event_4.jpg" class="thickbox" title="title 4" rel="gallery"><img src="img/president_cup_thumb_event_4.jpg" width="88" height="88" alt="" /></a></li>
									</ul>														
							</div>
					</div>
					</div>
