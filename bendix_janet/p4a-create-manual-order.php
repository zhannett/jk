    	...
    	<div class="page">
          ...
          <div id="content">
            <div class="title">
                ...
                <span>Reference #: <span id="ref">#ST001002003-BT0001</span></span>
            </div>
                ...
                <fieldset>
                	<ul id="tradedata2">
                        ...
                        <li>
                            ...
                            <span id="amount1" class="saved"></span>
                        </li>
                        <li>
                        ...
                        <li>
                        	<label for="date">Trade Date</label><br/>
                            <span id="date" class="saved"></span>
                        </li>
                        <li>
                        	 <span id="fee"></span>
                        </li>
