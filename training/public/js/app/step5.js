Ext.onReady(function(){
    ...
    var grid = new Ext.grid.GridPanel({
        title: 'Center "Fill" Region with Inner Border Layout and a Grid',
        region: 'center',
        store: store,
        columns: [
    ...
    var viewport = new Ext.Viewport({
        ...
        items: [
            ...
            items: [ grid,{
                ...
                collapsible: true,
                collapseMode: 'mini',
                html: '<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Sed metus nibh, sodales a, porta at, vulputate eget, dui. Pellentesque ut nisl.</p>'
            }]
        }]
    });
});
