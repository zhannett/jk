<?php # Script 15.6 - post_form.php
		...
		if (!isset($words)) {
			header ("Location: http://www.janetkulyk.com/index.php");
			exit();
		}
		...
		if (isset($_SESSION['user_id'])) {
			...
			// Display the form:
			echo '<form action="forum_post.php" method="post" accept-charset="utf-8">';
			
			// If on read.php...
			if (isset($tid) && $tid) {
			
				// Print a caption:
				echo '<h5 class="center">' . $words['post_a_reply'] . '</h5>';
			...
			echo '<p class="attention">You must be logged in to post messages.</p>';
		}
