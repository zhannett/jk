...
function initializeSlider(){
	...
	$('#slide0').click(function(){
		...
		jwplayer('video').setup({
			...
			plugins: 'gapro-2, captions',
			'gapro-2.accountid': 'UA-28932409-10',
			'gapro-2.trackingobject': _gaq,
			'gapro-2.trackstarts': true,
			'gapro-2.trackpercentage': true,
			'gapro-2.tracktime': true,
